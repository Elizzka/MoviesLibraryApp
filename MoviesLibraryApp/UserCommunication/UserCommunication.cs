...
public class UserCommunication : IUserCommunication
{
        ...
        MoviesLibraryAppDbContext moviesLibraryAppDbContext)
    {
        ...
        _movieRepo.ItemUpdated += (sender, movie) =>
        {
            _movieAuditService.LogAudit("Movie data updated", movie);
            Console.WriteLine($"{DateTime.Now:yyyy-MM-dd HH:mm:ss} - Movie data updated - {movie.Title}");
        };

        _seriesRepo.ItemUpdated += (sender, series) =>
        {
            _seriesAuditService.LogAudit("Series data updated", series);
            Console.WriteLine($"{DateTime.Now:yyyy-MM-dd HH:mm:ss} - Series data updated - {series.Title}");
        };
    }
